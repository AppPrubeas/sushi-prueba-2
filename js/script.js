document.addEventListener('DOMContentLoaded', () => {
    ...
    const body = document.body; // Referencia al body para controlar la clase
    ...
    toggleSidebarBtn.addEventListener('click', () => {
        ...
        body.classList.toggle('sidebar-active'); // Agrega/quita clase al body para mover el contenido/botón
    });

    // Ocultar sidebar en móviles si se hace clic en el contenido principal cuando el sidebar está abierto
    ...
    // Cierra el sidebar cuando se hace clic en un enlace de navegación
    ...
    if (carouselContainer) { // Solo iniciar el carrusel si estamos en la página de inicio (o index.html)
        setInterval(() => {
